...
export default {
  ...
  zucman: {
    ...
    burdenText: 'Zucmans Massstab ist der Anteil <em>am Marktvermögen</em>, und dort fällt die effektive Last tief aus. Die <strong>Vermögenssteuer</strong> bringt schweizweit rund 11&nbsp;Mrd. im Jahr, etwa 0,25&nbsp;% des gesamten Vermögens; der durchschnittliche Satz liegt bei 0,28&nbsp;% des <em>steuerbaren</em> Vermögens, abgemildert durch die kantonale Steuerbremse und die Lücke zwischen Markt- und Steuerwert, geschätzt also rund 0,3&nbsp;% des Marktvermögens. Dazu kommt die <strong>Einkommenssteuer auf die Vermögenserträge</strong>; Kapitalgewinne sind steuerfrei, Dividenden privilegiert besteuert, was grob 0,5&nbsp;% des Marktvermögens ergibt. Aufs <em>Einkommen</em> bezogen zahlen Schweizer Milliardäre rund 32&nbsp;% und typische Multimillionäre rund 19&nbsp;%, doch in diesen Sätzen steckt die Gewinnsteuer ihrer Unternehmen. Von den 32&nbsp;% eines Milliardärs entfallen laut der detaillierten Länderstudie (Roche-Erbe) nur rund 18&nbsp;Prozentpunkte auf seine persönliche Einkommenssteuer, der Rest ist die Gewinnsteuer seiner Beteiligung; die Vermögenssteuer kommt mit rund 10&nbsp;Prozentpunkten obendrauf, beim Multimillionär ist der Unternehmensanteil kleiner. Hohe Sätze, aber auf ein klein deklariertes Einkommen, daher nur etwa 1&nbsp;% des Vermögens. In der Summe liegt die heutige Effektivlast geschätzt bei <span class="hl">rund 0,8&nbsp;bis&nbsp;1&nbsp;% des Marktvermögens</span>. Das ist eine eigene Schätzung mit offengelegter Rechnung, keine amtliche Zahl, und sie schwankt stark nach Kanton und Ertragslage.',
    burdenSource: 'effektive Sätze Milliardäre/Multimillionäre',
    breakdownSource: 'Aufschlüsselung nach Steuerart (Personenanteil)',
    ...
    deriveInput3: 'Persönliche Einkommenssteuer auf Ausschüttungen rund 25 bis 30&nbsp;% (privilegierte Dividendenbesteuerung). Die Gewinnsteuer der Unternehmen zählt hier nicht, sie ist keine Steuer der natürlichen Person (Länderstudie Martínez).',
    ...
    deriveStep2: 'Einkommenssteuer am Marktvermögen ≈ 0,5&nbsp;% (rund 2&nbsp;% steuerbare Ausschüttungsrendite × 25 bis 30&nbsp;% persönlicher Einkommenssteuersatz, ohne Unternehmenssteuern).',
    ...
    deriveNote: 'Statisch gerechnet, ohne Verhaltensreaktion. Die Mindeststeuer trifft die natürliche Person, daher fliesst nur die Personensteuer (Vermögens- plus Einkommenssteuer) in <em>t₀</em> ein; die Gewinnsteuer der Unternehmen bleibt aussen vor. Die kursierende Quote von rund 32&nbsp;% enthält jene Unternehmenssteuern und dient hier nur als Quervergleich: 32&nbsp;% auf ein klein deklariertes Einkommen entsprechen rund 1&nbsp;% des Vermögens. Was angerechnet wird, verschiebt Szenario&nbsp;B: nur die Einkommenssteuer angerechnet ergäbe rund 12 bis 13&nbsp;Mrd. Die Basis ist eine belegte Untergrenze.',
