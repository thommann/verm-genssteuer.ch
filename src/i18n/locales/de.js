...
export default {
  ...
  zucman: {
    ...
    basisText: 'Beste belegte Quelle für das Marktvermögen ist die Bilanz-Reichstenliste. 2025 weist sie 851,5&nbsp;Mrd. für die 300&nbsp;Reichsten aus, ein neuer Höchststand und 18&nbsp;Mrd. mehr als 2024 (833,5&nbsp;Mrd.). Die Top&nbsp;10 halten zusammen <span class="hl gold">227&nbsp;Mrd.</span>, mehr als ein Viertel des Ganzen; reichster ist Gérard&nbsp;Wertheimer mit rund 33&nbsp;Mrd. Die Liste ist eine Annäherung und tendenziell ein Unterzähler: diskret gehaltene Vermögen fehlen, und sie läuft bei Rang&nbsp;300 auf rund 100&nbsp;Mio. aus. Die belegten 851,5&nbsp;Mrd. sind deshalb eine Untergrenze; realistisch liegt das Gesamtvermögen ab 100&nbsp;Mio. eher bei 850 bis 1000&nbsp;Mrd. Für alle Rechnungen wird die belegte Zahl als konservative Basis verwendet. Das steuerbare Vermögen der ESTV liegt deutlich tiefer, weil Beteiligungen zu Substanz- statt Verkehrswerten und Liegenschaften zu Steuerwerten erfasst werden.',

    burdenHeading: 'Heutige Steuerlast dieser Gruppe',
    burdenText: 'Zucmans Massstab ist der Anteil <em>am Marktvermögen</em>, und dort fällt die effektive Last tief aus. Die Vermögenssteuer bringt schweizweit rund 11&nbsp;Mrd. im Jahr, etwa 0,25&nbsp;% des gesamten Vermögens; der durchschnittliche Satz liegt bei 0,28&nbsp;% des <em>steuerbaren</em> Vermögens, abgemildert durch die kantonale Steuerbremse und die Lücke zwischen Markt- und Steuerwert, geschätzt also rund 0,3&nbsp;% des Marktvermögens. Dazu kommt die Einkommenssteuer auf die Vermögenserträge; Kapitalgewinne sind steuerfrei, Dividenden privilegiert besteuert, was grob 0,5&nbsp;% des Marktvermögens ergibt. Aufs <em>Einkommen</em> bezogen zahlen Schweizer Milliardäre rund 32&nbsp;% (inklusive Unternehmenssteuern) und typische Multimillionäre rund 19&nbsp;%, hohe Sätze, aber auf ein klein deklariertes Einkommen, daher nur etwa 1&nbsp;% des Vermögens. In der Summe liegt die heutige Effektivlast geschätzt bei <span class="hl">rund 0,8&nbsp;bis&nbsp;1&nbsp;% des Marktvermögens</span>. Das ist eine eigene Schätzung mit offengelegter Rechnung, keine amtliche Zahl, und sie schwankt stark nach Kanton und Ertragslage.',
    burdenSource: 'effektive Sätze Milliardäre/Multimillionäre',

    scenarioHeading: 'Zwei sehr verschiedene Zahlen',
    scenarioIntro: 'Entscheidend ist, dass Zucman eine Mindeststeuer vorschlägt, keine zusätzliche Abgabe obendrauf. Wer bereits 2&nbsp;% zahlt, ist befreit; wer darunter liegt, stockt auf. Ob man die heute schon gezahlten Steuern anrechnet oder nicht, trennt zwei Ergebnisse, die weit auseinanderliegen (Basis 851,5&nbsp;Mrd.):',
    thScenario: 'Szenario',
    thCalc: 'Rechnung',
    thRevenue: 'Aufkommen',
    rowAName: 'Brutto 2&nbsp;%',
    ...
    coreText: 'Zucmans Instrument wurde für Länder ohne Vermögenssteuer entworfen, in denen Milliardäre effektiv nur rund 0,5&nbsp;% ihres Vermögens an Einkommenssteuer zahlen (Frankreich 2016: 0,005&nbsp;%). Die Schweiz erhebt bereits eine Vermögenssteuer, die etwa die Hälfte der 2&nbsp;%-Schwelle abdeckt. Deshalb ist hier der Brutto-Effekt (rund 17&nbsp;Mrd.) gross, der eigentliche Mindeststeuer-Effekt (rund 6&nbsp;bis&nbsp;11&nbsp;Mrd. zusätzlich) aber proportional am kleinsten. Die Schweiz ist damit der Ort, an dem Zucmans Mindeststeuer am wenigsten zusätzlich einbringt, gerade weil sie das Problem, das die Steuer lösen soll, teilweise schon angeht.',
