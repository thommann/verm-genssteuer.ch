...
export default {
  ...
  calculator: {
    ...
    wegzugHead: '<strong>{cnt}</strong> Steuerpflichtige ({year}) mit Vermögen über {schwelle} verlassen die Schweiz. Ausfall pro Jahr:',
    wegzugNeuLabel: 'Neue Vermögenssteuer (Ausfall)',
    wegzugHeuteHead: 'Heutige Steuern dieser Gruppe',
    wegzugVstLabel: 'Vermögenssteuer (Ø {rate} eff.)',
    wegzugEstLabel: 'Einkommenssteuer auf Kapital (~{rate})',
    wegzugHeuteSumLabel: 'Heutige Steuern zusammen',
    wegzugGesamtLabel: 'Gesamtausfall',
    wegzugNote: 'Steuerbares Vermögen (ESTV) liegt unter dem Marktwert. Heutige Sätze: Schätzung auf Basis:',
    wegzugSourceVst: 'Ø Vermögenssteuersatz 0,28 %',
    wegzugSourceEst: 'Einkommenssteuer auf Kapitalerträge ~0,5 %',
