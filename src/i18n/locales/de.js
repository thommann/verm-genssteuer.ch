...
export default {
  ...
  spend: {
    ...
    sbbTitle: 'SBB-Billette günstiger',
    sbbOver: 'gratis',
    sbbTextOver: 'Genug, um den <strong>gesamten SBB-Personenverkehr gratis</strong> zu machen, also alle Billette und Abos für Fern- und Regionalverkehr.',
    sbbTextUnder: 'So viel günstiger könnten <strong>alle SBB-Billette und -Abos</strong> werden, über Fern- und Regionalverkehr zusammen.',
    sbbFootOver: 'Reicht sogar für den gesamten Personenverkehr des ganzen öV (Bahn, Bus, Tram).',
    sbbFootUnder: 'Auf den ganzen öV (Bahn, Bus, Tram) gerechnet wären es {pct}.',
    ...
    disclaimer: 'Bezugsgrössen aus offiziellen Quellen (EFV/ESTV, BAG, BFS, SBB, LITRA), gerundet, nominal. Es ist <em>entweder/oder</em>: jeder Franken kann nur einmal ausgegeben werden. Die Beispiele zeigen die Grössenordnung, keine fertige Politik.',
