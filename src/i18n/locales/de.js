...
export default {
  ...
  spend: {
    ...
    f35TextUnder: 'So viele F-35A liessen sich zum tatsächlichen Gesamtstückpreis von rund CHF {price} Mio. kaufen. Die Schweizer Armee beschafft {fleet} Stück.',
    f35TextOver: 'Die ganze Schweizer Flotte von {fleet} F-35A wäre finanziert, und es blieben noch {extra} weitere Jets übrig.',
