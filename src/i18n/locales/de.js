...
export default {
  ...
  zucman: {
    ...
    medUnit: 'Jahre',
    medSub: 'Die <strong>ganze Mindeststeuer von 2&nbsp;%</strong> der Superreichen ist passiv in gut drei Monaten verdient. Für seine <strong>gesamte Jahressteuer</strong> bräuchte ein normaler Haushalt aus passivem Einkommen rund 2,7&nbsp;Jahre, also fast zehnmal so lange. Und das ist erst der Durchschnitt: beim typischen Haushalt liegt das Vermögenseinkommen noch tiefer, er zahlt seine Steuern aus dem Lohn.',
