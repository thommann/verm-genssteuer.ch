...
export default {
  ...
  spend: {
    ...
    taxfreeUnit: 'Jahre',
    taxfreeText: 'So viele Jahrgänge dieser Einnahmen ergäben zusammen <strong>alle Steuern und Abgaben der Schweiz</strong> (Bund, Kantone, Gemeinden, Sozialwerke) für ein einziges steuerfreies Jahr.',
    taxfreeFoot: 'Pro Jahr deckt das Aufkommen rund {pct} aller Steuern und Abgaben in der Schweiz.',
