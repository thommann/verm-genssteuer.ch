...
export default {
  ...
  zucman: {
    ...
    deriveInput3: 'Effektive Steuerquote der Spitze rund 32&nbsp;% (Milliardäre) bzw. 19&nbsp;% (Multimillionäre) des Einkommens, in beiden Werten sind die Gewinnsteuern ihrer Unternehmen bereits miteingerechnet (Oxfam/Tax&nbsp;Justice&nbsp;Network/Momentum).',
