...
export default {
  ...
  ownership: {
    ...
    reichsteSwissLabel: 'Schweizer oder Liechtensteiner unter den {total}&nbsp;Reichsten',
    reichsteForeignLabel: 'Ausländer mit Wohnsitz in der Schweiz unter den {total}&nbsp;Reichsten',
    reichsteShareLabel: 'Ausländeranteil unter den Reichsten',
    reichsteChartTitle: 'Pass der 300 Reichsten',
    reichsteChartIntro: 'Anteil der 300 reichsten Personen mit Wohnsitz in der Schweiz nach Pass. In die Liste kommt, wer hier wohnt, unabhängig von der Staatsangehörigkeit. Wie viel des reichsten 1&nbsp;% insgesamt einen Schweizer Pass hat, wird amtlich nicht erfasst.',
    reichsteSource: 'Anteil nach Pass, Liste {jahr}',
    ...
    top300BipTitle: 'Die 300 im Verhältnis zum BIP',
    top300BipIntro: 'Vermögen der 300 Reichsten als Anteil am jährlichen BIP der Schweiz: stabil etwa eine ganze Jahres-Wirtschaftsleistung. Kurze Reihe, da frei belegte Gesamtwerte erst ab 2022 vorliegen.',
    top300BipLine: '300 ÷ BIP',
    top300BipSourceBilanz: 'Vermögen der 300: Bilanz, 2022–2024',
    ...
    groesste_armee: 'Armee (VBS): grösster Grundbesitzer der Schweiz',
    groesste_sbb: 'SBB: grösster Grundbesitzer nach der Armee',
    ...
    groesste_einsiedeln: 'Kloster Einsiedeln: grösster privater Grundbesitzer',
    groesste_hiag: 'Hiag (Familie Grisard): einer der grössten privaten Flächenbesitzer',
    waldChartTitle: 'Waldeigentum: öffentlich oder privat',
    waldChartIntro: 'Anteil der Waldfläche der Schweiz ({flaeche}&nbsp;ha, rund {landanteil} der Landesfläche) nach Eigentümertyp. Der Wald gehört {eigentuemer} Eigentümern; ein Privatwald misst im Schnitt nur {schnitt}&nbsp;ha, etwa zwei Fussballfelder. Öffentliche Wälder gehören Gemeinden, Bürger- und Burgergemeinden, Korporationen, Kantonen und dem Bund.',
    arealSource: 'Bodennutzung, Arealstatistik',
    waldChartSource: 'Waldfläche nach Eigentümertyp, {jahr}',
    waldTrendTitle: 'Waldeigentum über die Jahrzehnte',
    waldTrendIntro: 'Öffentlicher Anteil an der Waldfläche der Schweiz, 1975 bis 2024. Stabil hoch, mit einem leichten Rückgang zugunsten privater Wälder.',
    waldTrendSource: 'Waldfläche nach Eigentümertyp, 1975–2024',
    ...
    auslandZweitLabel: 'der Zweitwohnsitze in den Tourismusgebieten gehören Schweizern',
    auslandBlackrockLabel: 'der Aktien der börsenkotierten Schweizer Immobilienfirmen hält allein BlackRock ({wert}&nbsp;Mrd. CHF, {firmen}&nbsp;Firmen)',
    auslandNote: 'Die Beteiligung von BlackRock hat sich in zehn Jahren fast um das {faktor}-Fache erhöht; an der Swiss Prime Site hält der Vermögensverwalter über {sps}. Eine amtliche Gesamtzahl, wie viel des Schweizer Bodens Personen im Ausland gehört, gibt es nicht.',
    auslandAusnahmen: 'Es gibt aber Ausnahmen: EU- und EFTA-Staatsangehörige mit Wohnsitz in der Schweiz gelten nicht als Personen im Ausland und können unbeschränkt erwerben; Drittstaatsangehörige mit Aufenthaltsbewilligung B dürfen eine selbstbewohnte Hauptwohnung kaufen, und Geschäftsliegenschaften sind unabhängig von der Herkunft bewilligungsfrei.',
    ausnahmenSource: 'Bewilligungsfreie Fälle',
    auslandReform: 'Der Bundesrat will die Lex Koller verschärfen: Seit dem 15.&nbsp;April 2026 läuft die Vernehmlassung, geplant sind unter anderem eine Bewilligungspflicht für Drittstaatsangehörige und ein Verbot börsenkotierter Anteile an Wohnimmobiliengesellschaften.',
    lexKollerSource: 'Ferienwohnungs-Bewilligungen, {jahr}',
    blackrockSource: 'BlackRock an CH-Immobilienfirmen',
    reformSource: 'Vernehmlassung Lex-Koller-Revision, 2026',
  },
