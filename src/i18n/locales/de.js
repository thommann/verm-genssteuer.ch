...
export default {
  ...
  calculator: {
    ...
    wegzugHint: 'Alle Steuerpflichtigen mit Vermögen über diesem Betrag gelten im Szenario als weggezogen und zahlen keine Steuer mehr.',
    wegzugNone: 'kein Wegzug',
    wegzugInfo: '<strong>{cnt}</strong> Steuerpflichtige ({year}) mit Vermögen über {schwelle} sind weggezogen. Aufkommen sinkt um <strong>{verlust}</strong>.',
