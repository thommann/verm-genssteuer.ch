...
nicht Teil des Steuermodells. Zwei Herkunftsarten, im Feld ``bezug`` ausgewiesen:
  ...
  - "kuratiert" EFV-/BAG-/LITRA-Aggregate: als belegte Konstanten unten gepflegt.
                ...
                Verbandsgrafik); der Bezug ist als Runbook in docs/QUELLEN.md §5 notiert.
...
CURATED = {
    ...
    "oev_personenverkehrsertrag": {
        ...
        # öV (alle Transportunternehmen, Bahn, Bus, Tram) = 7'482 Mio. LITRA-Schätzung.
        "value": 7482000000,
...
def main():
    ...
    out = {
        "hinweis": ("Einordnungsgrössen für das «Was tun mit dem Geld?»-Modul, reine "
                    ...
                    "(bezug=skript); EFV-/BAG-/LITRA-Aggregate belegte Konstanten "
    ...
    print(f"  [OK ] spend_reference.json: BFS-Bevölkerung {pop_value:,} ({pop_jahr}, live); "
          f"{len(CURATED)} kuratierte EFV/BAG/LITRA-Grössen")
