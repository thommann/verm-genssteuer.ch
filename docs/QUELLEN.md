...
| Aussagen (Startseite) | Kampagnen-Aussagen mit konkreten Zahlen: Milliardäre zahlen halb so viel / Mittelstand doppelt so viel (Einkommensteuerlast); reales Vermögenswachstum 6 bis 9 % p. a. (Wegzug-Argument) | Zucman (`zucman_g20`) | — (Texte + `sources.json`) | — |
